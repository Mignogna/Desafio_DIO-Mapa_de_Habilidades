...
- 🌍 Idiomas: inglês, italiano e espanhol, além de domínio da escrita clara em português.  
- 💻 Tecnologia: programação frontend, Figma e UX Design generalista.  
- 📐 Soft Skills: organização, atenção aos detalhes e foco na experiência do usuário.  

A proposta foi refletir sobre como anunciar e estruturar meu trabalho em plataformas como **Upwork, Fiverr e Workana**, criando perfis atrativos e estratégias de divulgação para iniciar minha jornada como freelancer.  

---

## 🎯 Objetivo
O objetivo deste desafio é aplicar conceitos de **Inteligência Artificial** aliados às minhas competências pessoais e profissionais, construindo um caminho prático para atuação no mercado digital.  
